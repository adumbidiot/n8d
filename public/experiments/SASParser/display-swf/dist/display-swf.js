var DisplaySWF = (function () {
	...
	function create_main_fragment$1(component, ctx) {
		var details, summary, text_value = ctx.tag.name, text, text_1, text_2_value = ctx.tag.recordHeader.code, text_2, text_3, text_4, text_5, p;
				...
				if (changed.Object || changed.tag) {
					...
					for (var i = 0; i < each_value.length; i += 1) {
						...
						if (each_blocks[i]) {
							...
							each_blocks[i].c();
							each_blocks[i].m(details, text_5);
						}
					}
	...
	// (5:1) {#each Object.keys(tag) as key}
	...
	assign(Display_swf_tag.prototype, methods$1);
	...
	function create_main_fragment$2(component, ctx) {
		...
		var if_block = (ctx.tags.length > 0) && create_if_block(component, ctx);
	...
	assign(Display_swf.prototype, methods$2);
