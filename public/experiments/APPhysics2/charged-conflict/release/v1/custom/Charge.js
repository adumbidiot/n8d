...
export default function(game){
	...
	let Circle = game.collider.getColliderDef('Circle');
	
	return class Charge extends CircleEntity{
		constructor(opts){
			super(opts);
			...
			this.ax = 0;
			this.ay = 0;
			this.stage.collider.insert(new Circle({x: this.x, y: this.y, r: this.radius, parent: this, id: 'charge' + this.id}));
		}
		render(){
			super.render();
		}
