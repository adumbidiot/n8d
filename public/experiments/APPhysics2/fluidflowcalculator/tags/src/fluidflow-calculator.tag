<fluidflow-calculator>
	...
	<div style="width: 100%; height: 100%; background-color: grey; text-align: center;">
		<p>Fluid Flow Calculator</p>
		<div style="height: 3rem; ">
			<div style="float: left; display: inline-block; width: 100%;">
			<div class="input-wrapper" style="position: absolute; left: 0 rem;">
				(<input class="input" type="text" riot-value={opts.M1} placeholder="A1" onchange={change} ref="A1"> m^2)
				(<input class="input" type="text" riot-value={opts.V1} placeholder="V1" onchange={change} ref="V1"> m/s)
			</div>
			<div style="width: 2%; margin: auto; text-align: center; position: absolute;left: 49%;" class="input-wrapper">
				=
			</div>
			<div class="input-wrapper" style="position: absolute; right: 0rem;">
				(<input class="input" type="text" riot-value={opts.M2} placeholder="A2" onchange={change} ref="A2"> m^2)
				(<input class="input" type="text" riot-value={opts.V2} placeholder="V2" onchange={change} ref="V2"> m/s)
			</div>
			</div>
		</div>
		<div>
			<div onclick={calculate} style="user-select: none; background-color: white; width: 4rem; margin: auto;">Calculate</div>
		</div>
		<div>{error}</div>
	</div>
	<script>
